...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'AccessToken', fields ['expires']
        db.create_index(u'oauth_tokens_accesstoken', ['expires'])


    def backwards(self, orm):
        # Removing index on 'AccessToken', fields ['expires']
        db.delete_index(u'oauth_tokens_accesstoken', ['expires'])
